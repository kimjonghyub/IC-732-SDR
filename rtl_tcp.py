...
DEFAULT_SAMPLERATE = 2048000  # 2.048 MSPS
...
class RtlTcpHandler:
    ...
    def __init__(self):
        self.sdr = None
        self.iq_buffer = asyncio.Queue(maxsize=20)
    ...
    def initialize_device(self):
        ...
        try:
            ...
            self.sdr.RTLSDR_BUFFER_LENGTH = 512 * 1024
...
async def start_server(rtl_handler, host="0.0.0.0", port=1234):
...
async def main():
    ...
    try:
        await start_server(rtl_handler, host="192.168.10.216", port=1234)
    finally:
        rtl_handler.close()
